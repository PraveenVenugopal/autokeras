...
Given we want to run a model, let's say Image classifier, the following steps can create a .PDF depiction of the best architecture that was chosen to run your model of choice. 

Step 1 : Specify a path while running your model
